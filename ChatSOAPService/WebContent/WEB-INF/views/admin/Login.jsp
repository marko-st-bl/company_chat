...
<body onload="javascript:document.LoginForm.userName.focus();">
	...
	<table summary="main content table" class="FULL_BLANK">
		<tr>
			<td valign="top">
				<h2>Welcome :</h2>
				<p>Welcome to the Axis2 administration console. From inside the
					Axis2 administration console you can :</p>
				...
				</ul> <span style="color: orange">Warning: Please note that
					configuration changes done through the administration console will
					be lost when the server is restarted.</span>
			</td>
			<td valign="top" align="left">
				<form method="post" name="LoginForm" action="axis2-admin/login">
					<table summary="login table" class="LOG_IN_FORM">
						<tr>
							<td align="center" colspan="2" style="bgcolor: #b0b0b0"><span
								style="color: #FFFFFF">Login</span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input style="align: left" type="text" name="userName"
								tabindex="1"></td>
						</tr>
						<tr>
							<td align="right">Password :</td>
							<td><input style="align: left" type="password"
						...
						<tr>
							<td align="center" colspan="2"><input name="cancel"
								type="reset" value=" Clear "> &nbsp; &nbsp; <input
								name="submit" type="submit" value=" Login "></td>
						</tr>
						<tr>
							<td align="center" colspan="2"><span style="color: red">&nbsp;<% if (request.getAttribute("errorMessage") != null) {%><%= request.getAttribute("errorMessage")%>
									<% } %>&nbsp;
							</span></td>
						</tr>
					</table>

...
<body>
	...
	<%
          ...
          String  serviceName = axisService.getName();
            %><h2>
		<a style="color: blue" href="<%=prifix + axisService.getName()%>?wsdl"><%=serviceName%></a>
	</h2>
	<p>
		<span style="color: blue">Service EPR :</span> <span
			style="color: black"><%=prifix + axisService.getName()%></span>
	</p>

	<h4>
		Service Description : <span style="color: blue"><%=axisService.getDocumentation()%></span>
	</h4>
	<p>
		<span style="color: blue; font-style: italic">Service Status :
			<%=axisService.isActive()?"Active":"InActive"%></span>
	</p>
	<%
            if (opItr.hasNext()) {
	...
	<%
                ...
                %><span style="font-style: italic"> There are no
		Operations specified</span>
	<%
            }
